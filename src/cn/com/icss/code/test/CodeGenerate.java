...
//		panel.add(projectName);
		...
		final JTextField authorName = new JTextField("maggie");
		...
		ActionListener a1=new ActionListener(){   
			public void actionPerformed(ActionEvent e){    
				//生成代码
				generateCode(
							tableName.getText(),//数据库表名
							moduleName.getText(),//模块名称(包名)
							proxClassName.getText(),//实体名称(类名)
							proxClassZhName.getText(),//实体中文名称
							authorName.getText()//作者名称
							);
			}   
		};   
