...
public class CodeGreateUtils
{
	...
	public void init()
	{
		...
		bSb.append(basePackage).append(point).append(bean.getModelName()).append(".model.").append(bean.getUperName());
		bean.setImpBeanUrl(bSb.toString());
		// dao的路径
		StringBuffer dSb = new StringBuffer();
		dSb.append(basePackage).append(point).append(bean.getModelName()).append(".dao.").append(bean.getUperName()).append(mapper);
		bean.setImpDaoUrl(dSb.toString());

		// 设置其他包引用service路径
		StringBuffer iSb = new StringBuffer();
		iSb.append(basePackage).append(point).append(bean.getModelName()).append(".service.").append(bean.getUperName()).append(service);
		bean.setImpBeanServcieUrl(iSb.toString());

		// 设置其他包引用service实现的路径
		StringBuffer iiSb = new StringBuffer();
		iiSb.append(basePackage).append(point).append(bean.getModelName()).append(".service.").append(bean.getUperName()).append("ServiceImpl");
	...
	{
		String model_path = webPath + "/" + javaFolder + "/" + basePath + "/" + bean.getModelName() + "/model/";
		...
		String beanUrl = basePackage + "." + bean.getModelName() + ".model";
	...
	{
		String model_path = webPath + "/" + javaFolder + "/" + basePath + "/" + bean.getModelName() + "/dao/";
		...
		String beanUrl = basePackage + "." + bean.getModelName() + ".dao";
		bean.setBeanUrl(beanUrl);
	...
	{
		String model_path = webPath + "/" + javaFolder + "/" + basePath + "/" + bean.getModelName() + "/service/";
		...
		// 设置包路径
		String beanUrl = basePackage + "." + bean.getModelName() + ".service";
		bean.setBeanUrl(beanUrl);
	...
	{
		String model_path = webPath + "/" + javaFolder + "/" + basePath + "/" + bean.getModelName() + "/controller/";
		...
		FileWriter fw = new FileWriter(file);
		// 设置包路径
		String beanUrl = basePackage + "." + bean.getModelName() + ".controller";
		bean.setBeanUrl(beanUrl);
	...
	{
		String model_path = webPath + "/" + javaFolder + "/" + basePath + "/" + bean.getModelName() + "/mapping/";
		...
		FileWriter fw = new FileWriter(file);
		// 设置包路径
		String beanUrl = basePackage + "." + bean.getModelName() + ".mapping";
		bean.setBeanUrl(beanUrl);
	...
	{
		String model_path = webPath + "/" + webFolder + "/jsp/" + bean.getModelName() + "/" + bean.getLowerName() + "/";
		File filePath = new File(model_path);
		createFilePath(filePath);
		String fileName = model_path + "add" + bean.getUperName() + ".jsp";
		File file = new File(fileName);
		FileWriter fw = new FileWriter(file);
	...
	public void createEditView() throws Exception
	{
		...
		File filePath = new File(model_path);
		createFilePath(filePath);
		String fileName = model_path + "edit" + bean.getUperName() + ".jsp";
		File file = new File(fileName);
		FileWriter fw = new FileWriter(file);
	...
	public void createShowView() throws Exception
	{
		...
		File filePath = new File(model_path);
		createFilePath(filePath);
		String fileName = model_path + "show" + bean.getUperName() + ".jsp";
		File file = new File(fileName);
		FileWriter fw = new FileWriter(file);
	...
	public void createListView() throws Exception
	{
		...
		File filePath = new File(model_path);
		createFilePath(filePath);
		String fileName = model_path + "list" + bean.getUperName() + ".jsp";
		File file = new File(fileName);
		FileWriter fw = new FileWriter(file);
		String mapperVmPath = baseVmPath + "/list.vm";
		//是否支持国际化
		if (isHaveI18n.equals("false"))
		{
